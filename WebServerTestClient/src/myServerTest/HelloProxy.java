...
public class HelloProxy implements myServerTest.Hello {
  private String _endpoint = null;
  private myServerTest.Hello hello = null;
  ...
  private void _initHelloProxy() {
    try {
      hello = (new myServerTest.HelloServiceLocator()).getHello();
      if (hello != null) {
        if (_endpoint != null)
  ...
  public myServerTest.Hello getHello() {
    if (hello == null)
      _initHelloProxy();
    return hello;
  }
