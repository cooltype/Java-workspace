...
package myServerTest;

public class HelloServiceLocator extends org.apache.axis.client.Service implements myServerTest.HelloService {
    ...
    private java.lang.String Hello_address = "http://localhost:8080/WebServerTest/services/Hello";
    ...
    public myServerTest.Hello getHello() throws javax.xml.rpc.ServiceException {
    ...
    public myServerTest.Hello getHello(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            myServerTest.HelloSoapBindingStub _stub = new myServerTest.HelloSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (myServerTest.Hello.class.isAssignableFrom(serviceEndpointInterface)) {
                myServerTest.HelloSoapBindingStub _stub = new myServerTest.HelloSoapBindingStub(new java.net.URL(Hello_address), this);
                _stub.setPortName(getHelloWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://myServerTest", "HelloService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://myServerTest", "Hello"));
        }
